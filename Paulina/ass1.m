...
% Options for genetic
options_ga = optimoptions('ga', 'PopulationSize', 300,'FunctionTolerance', 0.01, 'Display', 'off', 'MaxGenerations', 200);
 
% Solver
   N = 1;
N_ga = 15; % Number of genetic algorithm iteration to have better results

dv_min_ga = 40;        % Arbitrary chosen value of total cost
...
fprintf('\n wdep %04d/%02d/%02d %02d:%02d:%02d\n', mjd20002date(w_dep(1)));
fprintf('wdep %04d/%02d/%02d %02d:%02d:%02d\n', mjd20002date(w_dep(end)));
fprintf('wfb %04d/%02d/%02d %02d:%02d:%02d\n', mjd20002date(w_fb(1)));
fprintf('wfb %04d/%02d/%02d %02d:%02d:%02d\n', mjd20002date(w_fb(end)));
fprintf('warr %04d/%02d/%02d %02d:%02d:%02d\n', mjd20002date(w_arr(1)));
fprintf('warr %04d/%02d/%02d %02d:%02d:%02d\n', mjd20002date(w_arr(end)));
fprintf('t1 %04d/%02d/%02d %02d:%02d:%02d\n', mjd20002date(t_opt_sol(1)));
fprintf('t2 %04d/%02d/%02d %02d:%02d:%02d\n', mjd20002date(t_opt_sol(2)));
fprintf('t3 %04d/%02d/%02d %02d:%02d:%02d\n \n', mjd20002date(t_opt_sol(3)));

[w_dep_datenum, w_fb_datenum, w_arr_datenum, t_opt_datenum] = datedata(w_dep, w_fb, w_arr, t_opt_sol);

% Ahora usa estos datenum para plotear
figure()
hold on
grid on
...
contour(w_fb_datenum, w_dep_datenum, delta_v1, 50); % Usa la malla y matriz correspondientes
colorbar
colormap jet
